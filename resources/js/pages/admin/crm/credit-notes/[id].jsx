...
const show = (props) => {
	...
	const downloadPDF = async () => {
		try {
			...
			const response = await Axios.get(`/api/credit-notes/${id}/preview`, {
				responseType: "blob",
			})
			...
			link.setAttribute("download", `CreditNote-${creditNote.code}.pdf`)
								...
								<div className="table-responsive-sm">
									<table className="table bg-white border">
										...
										<tbody>
											<tr>
												<td>
													Credit Note for Invoice {creditNote.invoiceCode}
												</td>
